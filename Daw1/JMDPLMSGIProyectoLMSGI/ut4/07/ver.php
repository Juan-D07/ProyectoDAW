...
<head>
    ...
    <title>Ut4.7 Juan Miguel Dominguez</title>
...
<body>
	<header>
		<h1> UT4.7 Tienda de Juegos</h1>
	</header>
	<main>
    <details class="ver">
        <summary>  Tienda de Juegos</summary>
         <iframe src="../doc/Ut4_07.pdf" width="100%" height="800px"></iframe>

    </details>
     <details class="ver">
        <summary> XML Tienda de Juegos</summary>
         <pre><?php echo htmlspecialchars($xml); ?></pre>
    </details>
	     <details class="ver">
        <summary> DTD Tienda de Juegos</summary>
         <pre><?php echo htmlspecialchars($dtd); ?></pre>
    </details>
		     <details class="ver">
        <summary> XSD Tienda de Juegos</summary>
