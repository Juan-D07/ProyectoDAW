...
<head>
    ...
    <title>Ut4.3 Juan Miguel Dominguez</title>
...
<body>
	<header>
		<h1> UT4.3 Programacion</h1>
	</header>
	<main>
        <div>
    <details class="ver">
        <summary>  Programacion</summary>
         <iframe src="../doc/Ut4_03.pdf" width="100%" height="800px"></iframe>

    </details>
    </div>
    <div>
     <details class="ver">
        <summary> XML Programacion</summary>
         <pre><?php echo htmlspecialchars($xml); ?></pre>
    </details>
    </div>
    <div>
	     <details class="ver">
        <summary> DTD Programacion</summary>
         <pre><?php echo htmlspecialchars($dtd); ?></pre>
    </details>
    </div>
    <div>
		     <details class="ver">
        <summary> XSD Programacion</summary>
