...
<head>
    ...
    <title>Ut4.4 Juan Miguel Dominguez</title>
...
<body>
	<header>
		<h1> UT4.4 Curriculum</h1>
	</header>
	<main>
    <div>
    <details class="ver">
        <summary>  Curriculum</summary>
         <iframe src="../doc/Ut4_04al06.pdf" width="100%" height="800px"></iframe>

    </details>
    </div>
    <div>
     <details class="ver">
        <summary> XML Curriculum</summary>
         <pre><?php echo htmlspecialchars($xml); ?></pre>
    </details>
    </div>
    <div>
	     <details class="ver">
        <summary> DTD Curriculum</summary>
         <pre><?php echo htmlspecialchars($dtd); ?></pre>
    </details>
    </div>
    <div>
		     <details class="ver">
        <summary> XSD Curriculum</summary>
